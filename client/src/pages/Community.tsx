...
const features = [
  {
    ...
    description:
      "Engage in meaningful discussions about trading strategies and market analysis",
  },
  {
    icon: Share2,
    title: "Trade Ideas",
      ...
      <div className="max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Connect with fellow traders, share insights, and grow together in
        ...
        <div className="bg-gray-800 rounded-lg p-8 text-center">
          <SiDiscord className="h-12 w-12 text-indigo-400 mx-auto mb-4" />
          <h2 className="text-2xl font-bold text-white mb-4">Ready to Join?</h2>
          <p className="text-gray-300 mb-6">
            Start connecting with traders from around the world and take your
            trading to the next level.
          </p>
          <a
            href="https://discord.gg/JeuKEVAU"
            target="_blank"
