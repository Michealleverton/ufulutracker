  ...
  return (
    ...
    >
      ...
      <section className="mb-8">
        ...
        <p className={`${theme === "light" ? "text-white" : "text-black"} mb-4`}>
      ...
      <section className="mb-8">
        ...
        <p className={`${theme === "light" ? "text-white" : "text-green-600"} mb-4`}>
      ...
      <section className="mb-8">
        ...
        <p className={`${theme === "light" ? "text-white" : "text-black"} mb-4`}>I will be risking 5% per trade.</p>
        <p className={`${theme === "light" ? "text-white" : "text-black"} mb-4`}>My Max Loss per Day is 5%.</p>
        <p className={`${theme === "light" ? "text-white" : "text-black"} mb-4`}>
        ...
        <p className={`${theme === "light" ? "text-white" : "text-black"} mb-4`}>Profit Target:</p>
        <p className={`${theme === "light" ? "text-white" : "text-black"} mb-4`}>
        ...
        <p className={`${theme === "light" ? "text-white" : "text-black"} mb-4`}>Monthly Profit Target of 100%</p>
        <p className={`${theme === "light" ? "text-white" : "text-black"} mb-4`}>
        ...
        <p className={`${theme === "light" ? "text-white" : "text-black"} mb-4`}>I target 25% per week.</p>
        <p className={`${theme === "light" ? "text-white" : "text-black"} mb-4`}>I’d love to achieve 200% per month.</p>
        <p className={`${theme === "light" ? "text-white" : "text-black"} mb-4`}>My current Win Rate is 80%.</p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className={`${theme === "light" ? "text-white" : "text-black"} mb-4`}>My Trading Pairs are:</p>
        <ul className={`${theme === "light" ? "text-white" : "text-black"} list-disc list-inside mb-4`}>
          <li>USD/CAD</li>
          <li>GOLD</li>
          <li>SILVER</li>
          <li>BITCOIN</li>
      ...
      <section className="mb-8">
        ...
        <p className={`${theme === "light" ? "text-white" : "text-black"} mb-4`}>Sign:</p>
        <p className={`${theme === "light" ? "text-white" : "text-black"} mb-4`}>
          {isEditingName ? (
            <input
              type="text"
              ...
              className={`${theme === "light" ? "text-white" : "text-black"} bg-transparent border border-indigo-300 rounded px-2 py-1 focus:outline-none focus:ring-2 focus:ring-indigo-300`}
              autoFocus
            />
          ) : (
            <p
              onClick={() => setIsEditingName(true)}
              className={`${theme === "light" ? "text-white" : "text-black"} mb-4 cursor-pointer hover:border hover:border-indigo-300 hover:rounded px-2 py-1`}
            >
              {name}
            </p>
          )}
