...
export const fetchWeeklyData = async (setWeeklyData: Function, calculateTotalWeeklyProfit: Function) => {
...
export const fetchTotalProfitLoss = async (updateTotalProfitLossCard: (total: number) => void) => {
...
export const fetchWinRate = async (updateWinRateCard: (winRate: number) => void) => {
  const { data, error } = await supabase.from("trades").select("*");
...
export const fetchBestTrade = async (updateBestTradeCard: (profit: number) => void) => {
  const { data, error } = await supabase.from("trades").select("*");
...
export const fetchWorstTrade = async (updateWorstTradeCard: (profit: number) => void) => {
  const { data, error } = await supabase.from("trades").select("*");
...
export const fetchEquityCurveData = async (setEquityCurveData: Function) => {
  ...
  export const fetchMonthlyProfitLossData = async (setMonthlyProfitLossData: Function) => {
    const { data, error } = await supabase.from("trades").select("*");
